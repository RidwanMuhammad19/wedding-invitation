...
export const wishlist = [
  ...
  {
    name: 'Ariel Ega Alfabel',
    infoName: 'Teman Desa Kraguman',
    description: `"Selamat menempuh perjalanan hidup baru Mas Ridwan dan Mbak Dewi, semoga dalam ikatan pernikahan ini diberikan keberkahan di dalamnya baik dalam kondisi susah maupun senang. Dan semoga pertemuan ini menjadi awal dari kebaikan-kebaikan selanjutnya."`,
    image: abel,
  },
  {
